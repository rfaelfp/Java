...
public class Filter {
	...
	public static void main(String[] args) {
		...
		Predicate<Aluno> aprovado = m -> m.nota >= 7; 
		Function<Aluno, String> saudacao = a -> "Parabéns " + a.nome + "! Você foi aprovado"; 
		
		alunos.stream()
			.filter(aprovado) // primeiro filtrei os alunos com nota maior que 7
			.map(saudacao) // Realizado mapeamento somente dos alunos acima de 7
